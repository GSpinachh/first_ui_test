...
class LoginPage(BasePage):
    ...
    @allure.step(r'Ввести логин {login}')
    ...
    @allure.step(r'Авторизоваться с логином {login} и паролем')
...
class InventoryPage(BasePage):
    def __init__(self, driver):
        ...
        self.add_jacket_to_catr_btn = (By.XPATH, '//*[@id="add-to-cart-sauce-labs-fleece-jacket"]') 
    ...
    @allure.step('Выбрать товар в корзину')
